...
public class CountryManager {
	...
	public void changeDefaultCountry(Country newDefault) throws NotSupportedCountryException {
		...
		mCountries.put(mDefaultCountryKey, 
			new Country(mDefaultCountryKey, country.getCountryName(), country.getVATTax(), false));
		mCountries.put(newDefaultId, 
			new Country(newDefaultId, newDefault.getCountryName(), newDefault.getVATTax(), true));
